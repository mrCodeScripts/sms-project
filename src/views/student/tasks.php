...
<head>
    ...
    ">
    <link rel="stylesheet" href="/css/student/task.css">
        ...
        <div class="main-content">
            ...
            <div class="student-tasks-container">
                <div class="tasks-report">
                    <div class="report-box" style="background-color: orange;">
                    ...
                    <div class="report-box" style="background-color: var(--success-1);">
                        <p class="report-value">
                            10
                        </p>
                        <p class="report-label">
                    ...
                    <div class="task">
                        ...
                        <div class="lower-controll">
                            ...
                            <div class="task-description">
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Deleniti possimus corporis iusto eligendi quasi impedit temporibus fugit ab vitae quas eius esse facilis minima, natus quibusdam, vel debitis iure. Nulla.
                            </div>
                        </div> 
                    </div>
                </div>
