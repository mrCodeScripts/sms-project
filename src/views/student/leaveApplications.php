...
<head>
    ...
    <link rel="stylesheet" href="/css/student/leaveApplication.css">
    ...
    <div class="ui_dashboard">
        ...
        <div class="main-content">
            ...
            <div class="leave-application-form">
                <form id="leave-application-form" class="form">
                    <div class="input-wrapper">
                        <select name="leave-request-sento" id="leave-request-sento">
                            <option value="">Administrator</option>
                        </select>
                        <i class="fa-solid fa-caret-right"></i>
                    </div>
                    <div class="input-wrapper" style="border: none !important;">
                        <textarea name="" id="" placeholder="Leave request description..."></textarea>
                    </div>
                    <button type="submit">
